    ...
    return (
        <>
            ...
            <div className="w-full bg-white/95 justify-between items-center px-16 py-3.5 shadow-md sticky top-0 z-[100] hidden lg:flex">
                <div className="pl-[5vw] font-['Times_New_Roman',_Times,_serif] font-bold cursor-pointer text-[30px] text-[rgba(92,34,116,0.83)] mt-3">
                    WedsWardrobe
                </div>
                ...
                <div className="flex gap-12">
                    ...
                    <div className="relative group">
                        <span className="text-[1.5rem] font-['Times_New_Roman',_Times,_serif] text-[rgba(92,34,116,0.83)] font-bold  cursor-pointer">
                            WomenWear
                        </span>
                ...
                <div className="flex items-center gap-5 pr-[5vw] py-2">
                    ...
                    <i
                        className="fas fa-home text-[21px] cursor-pointer text-[rgba(85,38,105,0.834)] hover:scale-104 transition-transform duration-200"
                        title="Home"
                        onClick={() => navigate("/")}
                    ></i>

                    <i className="fas fa-search text-[20px] text-[rgba(92,34,116,0.83)] hover:text-[#888] cursor-pointer" onClick={() => handleRedirect('/search')} title="Search"></i>

                    <i
                        className="far fa-user text-[20px] text-[rgba(92,34,116,0.83)] hover:text-[#888] cursor-pointer"
                        title="My Account"
                        onClick={() => {
                            const auth = getAuth();
            ...
            {/* Mobile Navbar */}
            < div className="w-full bg-white/95 flex justify-between items-center px-5 py-3 mt-5 top-0 z-[100] shadow-md sticky sm:px-10 lg:hidden" >
