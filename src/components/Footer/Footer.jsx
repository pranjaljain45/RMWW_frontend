    ...
    <footer className="footer">
      ...
      <div className="footer-columns">
        ...
        <div className="footer-column">
          <h3>OUR COMPANY</h3>
          <p onClick={() => handleRedirect('/OurProfile')}>OUR PROFILE</p>
          <p onClick={() => handleRedirect('/TnC')}>TERMS AND CONDITIONS</p>
          <p onClick={() => handleRedirect('/ContactUs')}>CONTACT US</p>
        </div>
        ...
        <div className="footer-column">
          ...
          <p onClick={() => handleRedirect('/PrivacyPolicies')}>PRIVACY POLICY</p>
        </div>

        {/* Contact Us */}
        <div className="footer-column">
          <h3>CONTACT US</h3>
          <a href="mailto:care@rentmyweddingwear.com">care@WedsWardrobe.com</a>
          <p>+91-987-654-3210</p>
        </div>
        ...
        <div className="footer-column">
          ...
          <a href="mailto:careers@rentmyweddingwear.com">careers@WedsWardrobe.com</a>
        </div>

      </div>

      <div className="footer-bottom">
        <p>© 2025WedsWardrobe. All Rights Reserved. WE LOVE TO DRESS YOU UP!</p>
      </div>
